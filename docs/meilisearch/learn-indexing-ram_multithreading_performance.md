...
**Source:** https://www.meilisearch.com/docs/learn/indexing/ram_multithreading_performance.md
**Extrait le:** 2025-10-08
**Sujet:** Indexing - Performance
...
In machines with multi-core processors, the indexer avoids using more than half of the available processing units. For example, if your machine has twelve cores, the indexer will try to use six of them at most. This ensures Meil
