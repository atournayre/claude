...
**Source:** https://platform.claude.com/docs/en/agent-sdk/migration-guide.md (redirected from https://code.claude.com/docs/en/sdk/migration-guide.md)
**Extrait le:** 2025-12-10
**Sujet:** Migration Guide - Migration du Claude Code SDK vers le Claude Agent SDK
